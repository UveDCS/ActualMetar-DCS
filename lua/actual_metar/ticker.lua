...
function M.install()
    ...
    if not ok then
        pcall(function() _G.log.write("actual_metar", _G.log.ERROR or 1, "UpdateManager.add fallo: " .. tostring(err)) end)
        return false
    end
    installed = true
    pcall(function() _G.log.write("actual_metar", _G.log.INFO or 3, "ticker instalado en UpdateManager") end)
    return true
end
