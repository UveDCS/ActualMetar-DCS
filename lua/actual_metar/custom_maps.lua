...
-- normal en <Saved Games>\DCS\actual-metar\custom_icaos.lua (mismo estilo que
...
local function serialize(list)
    local parts = { "-- generado por ACTUAL METAR - no editar mientras el editor este abierto\nreturn {\n" }
